	...
	.get('/reminder', passport.authenticate('basic', { session: false}), 
		function(req, res, next) {
			if (req.user.role === "admin") {
				User.find({}).populate('states').populate('states.category').exec(
					function(err, users) {
						if (err) return next(err);
